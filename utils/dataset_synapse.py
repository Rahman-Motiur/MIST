...
if __name__=='__main__':
    ...
    dataset=Synapse_dataset(base_dir='../data/synapse/train_npz_new/', list_dir='../lists/lists_Synapse', split="train", nclass=9,
                               transform=transforms.Compose(
                                   [RandomGenerator(output_size=[256, 256])]))
    db_test = Synapse_dataset(base_dir='../data/synapse/test_vol_h5_new/', split="test_vol", list_dir='../lists/lists_Synapse',nclass=9)
